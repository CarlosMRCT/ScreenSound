...
namespace ScreenSound.Migrations
{
    ...
    public partial class PopularTabela : Migration
    {
        ...
        {
            migrationBuilder.InsertData("Artistas", new string[] { "Nome", "Bio", "FotoPerfil" }, new object[] {"Djavan", "Djavan Caetano Viana é um cantor e compositor brasileiro", "https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_1280.png" });
